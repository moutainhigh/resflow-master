define(['module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/action/digitalCircutAction.js',
    'text!module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/templates/updateFrView.html',
...
], function(digitalCircutAction,updateFrView,i18n,css) {
    return fish.View.extend({
        template: fish.compile(updateFrView),
