define(['module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/action/digitalCircutAction.js',
    'text!module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/templates/frView.html',
...
], function(digitalCircutAction,frView,i18n,css) {
    var $grid;
    var productType;
    var productTypeText;
    ...
    return fish.View.extend({
        ...
        initGred:function (mydata) {
            ...
            var opt = {
                ...
                colModel: [
                    ...
                    {name: 'fr_bussiness_type', label: 'FR业务种类', width: 1,sorttype: "string",align:"center",hidden:true},
            ...
            $grid.on('click', '.js-delete', function() {
                ...
                var popup = fish.popupView({
                    url: 'module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/views/updateFrView',
                    width: "95%",
                    height:"90%",
                    modal:true,
                    canClose:true,
        ...
        if (actType!="101" && actType!="107"){
            $('#fr-Form').validator('setIgnoreField', 'circuitCode,CUST_TEL,CUST_EMAIL,CUST_NAME_CHINESE,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME,CUST_MANAGER,CUST_MANAGER_TEL', true);
        }else{
            $('#fr-Form').validator('setIgnoreField', 'CUST_TEL,CUST_EMAIL,CUST_NAME_CHINESE,circuitCode,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME,CUST_MANAGER,CUST_MANAGER_TEL', true);
        }
        var checkNull = $("#fr-Form").isValid();
        if (actType!="101" && actType!="107"){
            $('#fr-Form').validator('setIgnoreField', 'CUST_TEL,CUST_EMAIL,CUST_NAME_CHINESE,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME,CUST_MANAGER,CUST_MANAGER_TEL', false);
        }else{
            $('#fr-Form').validator('setIgnoreField', 'CUST_TEL,CUST_EMAIL,CUST_NAME_CHINESE,circuitCode,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME,CUST_MANAGER,CUST_MANAGER_TEL', false);
        }
        if(!checkNull){
        ...
        queryWorkOrders: function(page, rowNum, sortname, sortorder) {
            ...
            //获取表单信息
            var formValue = $('#fr-Form').form("value");
        ...
        submit:function () {
            ...
            $('#fr-Form').validator('setIgnoreField', 'tradeId,serialNumber,circuitCode,slaFlag' +
            ...
            var _this =this;
            $("#fr-Form").blockUI({message: '请稍后...'}).data('blockui-content', true);
            ...
            digitalCircutAction.orderInfoSubmit(orderInfoObj,function(data) {
                ...
                if(arrdata[0]=='success'){
                    ...
                    // fish.toast("success","");
                    $("#fr-Form").unblockUI().data('blockui-content', false);
                    _this.popup.close();
                }else{
                    $("#fr-Form").unblockUI().data('blockui-content', false);
        ...
        save:function () {
            ...
            var _this =this;
            $("#fr-Form").blockUI({message: '保存中'}).data('blockui-content', true);
