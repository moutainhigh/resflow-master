define([
        ...
        'text!module/UnicomLocalNet/LocalCircuitAppl/AreaCombotree/templates/feedBackInfoView.html',
    ...
    function(localOrderSelectAction,feedBackInfoView,i18n,css) {
        ...
        return fish.View.extend({
            ...
            afterRender: function() {
                ...
                document.getElementById("TACHE_NAME").innerText = selrow.TACHE_NAME;
                ...
                document.getElementById("COLLECT_RES_NAME").innerText = selrow.COLLECT_RES_NAME;
                document.getElementById("COLLECT_MONEY").innerText = selrow.COLLECT_MONEY;
                document.getElementById("COLLECT_DAY").innerText = selrow.COLLECT_DAY;
                document.getElementById("COLLECT_DESC").innerText = selrow.COLLECT_DESC;
            },
