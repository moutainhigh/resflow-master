define(['module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/action/digitalCircutAction.js',
    'text!module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/templates/updateVoiceRelayCircuitView.html',
...
], function(digitalCircutAction,updateVoiceRelayCircuitView,i18n,css) {
    return fish.View.extend({
        template: fish.compile(updateVoiceRelayCircuitView),
            ...
            for ( var key in arrayData) {
                ...
                if(key.indexOf("A_belong_city")>=0){
                    $("#sub_"+key).popedit({
                        ...
                        open:function(e) {
                            var _this = $(this);
                            var areaName = $("#sub_A_belong_province").popedit("getValue").name;
                            digitalCircutAction.queryAreaIdByName(areaName,function (data) {
                                var areaId = data.ID;
                                var options = {
                                    url: 'module/UnicomLocalNet/LocalCircuitAppl/AreaCombotree/views/provienceTreeView',
        ...
        initForm:function (actType) {
            if(actType=='101'){
                ...
                $("#sub_A_old_installed_add_div").hide();
                $("#sub_Z_old_installed_add_div").hide();
