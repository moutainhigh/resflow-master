define(['module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/action/digitalCircutAction.js',
    'text!module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/templates/diaView.html',
...
], function(digitalCircutAction,diaView,i18n,css) {
    var $grid;
    var productType;
    var productTypeText;
    ...
    return fish.View.extend({
        ...
        initCombobox:function(){
            ...
            /*   digitalCircutAction.queryEnum('10001302',function (data) {
             $('#networkType').combobox({
             placeholder: '--请选择--',
             dataTextField:'CODE_CONTENT',//数据源显示字段  ，后起别名name ，就可以省略;
             dataValueField:'CODE_VALUE',//数据源取值字段 ，后起别名name ，就可以省略;
             dataSource:data,//数据 array [];
             editable:false //是否可编辑，默认true。
             });
             });*/
            // var networkEnum = digitalCircutAction.queryEnum('10001302').responseJSON.data;
        ...
        initGred:function (mydata) {
            ...
            var opt = {
                ...
                colModel: [
                    ...
                    {name: 'CustApplIPV4Count', label: '客户申请IPv4地址的数量',  width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'CustApplIPV6Count', label: '客户申请IPv6地址的数量',  width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'EqpConnectIPCount', label: '设备互联IP数量',  width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'RoutProtocolType', label: '路由协议类型',  width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'IPAddrType', label: 'IP地址类型',  width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'IPAddrSource', label: 'IP地址来源',  width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'IPV4', label: 'IPv4地址',  width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'IPV6', label: 'IPv6地址',  width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'IPReferenceUnit', label: 'IP备案单位',  width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'WebsiteRecordNumber', label: '网站备案号',  width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'OpenWebsiteDomain', label: '开设网站域名',  width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'isBigSpeed', label: '是否大带宽',  width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'isNeedDNS', label: '是否需要域名解析',  width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'isNeedBroadcastbyuser', label: '用户地址是否需要广播',  width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'Z_belong_province', label: '归属省', width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'Z_belong_city', label: '归属地市', width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'Z_belong_county', label: '归属区县', width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'Z_belong_region', label: '归属区域', width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'Z_customer_name', label: '客户名称', width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'Z_installed_add', label: '装机地址', width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'Z_contact_man', label: '联系人', width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'Z_contact_tel', label: '联系电话', width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'Z_interface_type', label: '接口类型', width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'Z_old_belong_region', label: '原归属区域', width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'Z_old_belong_county', label: '原归属区县', width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'Z_old_installed_add', label: '原装机地址', width: 1,sorttype: "string",align:"center",hidden:true},
                    {name:'DDK',width:150 ,hidden:true},
                    {name:'upDDKLoadResult',hidden:true},
                    {name:'fileList',hidden:true},
            ...
            $grid.on('click', '.js-delete', function() {
                ...
                var popup = fish.popupView({
                    url: 'module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/views/updateDiaView',
                    width: "'95%",
                    height:"90%",
                    modal:true,
                    canClose:true,
                    ...
                    viewOption:{
                        ...
                        productType : productType,
                        actType:actType,
                        upDDKLoadResult:upDDKLoadResult,
                        flag:"edit"
                    },
                    callback:function(popup,view){
            ...
            //添加电路按钮
            $("#addAndSelectRow").click(function() {
                $(this).attr("disabled",true);
                setTimeout("$('#addAndSelectRow').attr('disabled', false)",1500); //延迟1.5S
                if (actType!="101" && actType!="107"){
                    $('#dia-Form').validator('setIgnoreField', 'CUST_TEL,CUST_EMAIL,CUST_NAME_CHINESE,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME', true);
                }else{
                    $('#dia-Form').validator('setIgnoreField', 'CUST_TEL,CUST_EMAIL,CUST_NAME_CHINESE,circuitCode,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME', true);
                }
                var checkNull = $("#dia-Form").isValid();
                if (actType!="101" && actType!="107"){
                    $('#dia-Form').validator('setIgnoreField', 'CUST_TEL,CUST_EMAIL,CUST_NAME_CHINESE,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME', false);
                }else{
                    $('#dia-Form').validator('setIgnoreField', 'CUST_TEL,CUST_EMAIL,CUST_NAME_CHINESE,circuitCode,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME', false);
                }
                if(!checkNull){
                    fish.error({title:'提示',message:'请检查必填数据或数据格式'});
                    return;
                }
                if($('#isBigSpeed').val()==1 && upDDKLoadResult.length==0){
                ...
                digitalCircutAction.checkTradeId({tradeId:$("#tradeId").val(),serialNumber:$("#serialNumber").val(),actType:actType,orderType:orderType.value},function (res) {
                    ...
                    digitalCircutAction.checkCircuitCode(param, function(res){
                        if(res.success){
                            ...
                            var circuitInfo = {};
                            var circuitCodeArea =['tradeId','serialNumber','serviceId','circuitReq','circuitCode','oldCircuitCode','speed','requFineTime','accepTime','createTime','proPriDeg','cirUse',"serviceName","circuitReqName","speedName", 'cir_remark', 'CustApplIPV4Count', 'CustApplIPV6Count', 'EqpConnectIPCount', 'RoutProtocolType', 'IPAddrType', 'IPAddrSource', 'IPV4', 'IPV6', 'IPReferenceUnit', 'WebsiteRecordNumber', 'OpenWebsiteDomain', 'isBigSpeed', 'isNeedDNS', 'isNeedBroadcastbyuser', 'Z_belong_province', 'Z_belong_city', 'Z_belong_county', 'Z_belong_region','Z_belong_region_id', 'Z_customer_name', 'Z_installed_add', 'Z_contact_man', 'Z_contact_tel', 'Z_interface_type', 'Z_old_belong_region', 'Z_old_belong_county', 'Z_old_installed_add','INSTANCE_ID','A_belong_city_id','Z_belong_city_id'];
                            ...
                            circuitInfo["DDK"]=$("#BigSpeedAttachment_down").html();
                            circuitInfo["upDDKLoadResult"]=upDDKLoadResult;
                            circuitInfo["fileList"]=fileList;
                            $("#BigSpeedAttachment_down").empty();
                            upDDKLoadResult = new Array();
        ...
        initPageParam:function () {
            ...
            if(actType=="101"){
                ...
                $("#old_belong_region").hide();
                $("#old_belong_county").hide();
                $("#old_installed_add").hide();
        ...
        queryWorkOrders: function(page, rowNum, sortname, sortorder) {
            ...
            //获取表单信息
            var formValue = $('#dia-Form').form("value");
        ...
        submit:function () {
            ...
            $('#dia-Form').validator('setIgnoreField', 'tradeId,serialNumber,circuitCode,cirUse,speed,Z_interface_type,requFineTime' +
                ',Z_belong_province,Z_belong_city,Z_contact_man,Z_contact_tel,Z_installed_add,Z_belong_region', true);
            var checkNull = $("#dia-Form").isValid();
            $('#dia-Form').validator('setIgnoreField', 'tradeId,serialNumber,circuitCode,cirUse,speed,Z_interface_type,requFineTime' +
                ',Z_belong_province,Z_belong_city,Z_contact_man,Z_contact_tel,Z_installed_add,Z_belong_region', false);
            if(!checkNull){
                // fish.toast("success","");
                fish.error({title:'提示',message:'请检查必填数据或数据格式'})
            ...
            var _this =this;
            $("#dia-Form").blockUI({message: '请稍后...'}).data('blockui-content', true);
            ...
            digitalCircutAction.orderInfoSubmit(orderInfoObj,function(data) {
                ...
                if(arrdata[0]=='success'){
                    ...
                    // fish.toast("success","");
                    $("#dia-Form").unblockUI().data('blockui-content', false);
                    _this.popup.close();
                }else{
                    $("#dia-Form").unblockUI().data('blockui-content', false);
        ...
        save:function () {
            ...
            var _this =this;
            $("#dia-Form").blockUI({message: '保存中'}).data('blockui-content', true);
                    ...
                    $('.file-remove').off('click').on('click', function (e) {
                        ...
                        for (var i = 0; i < upLoadResult.length; i++) {
                            if(upLoadResult[i][0].fileName==name){
                                ...
                                fileId=upLoadResult[i][0].fileId;
                                pos2=i;
                            }
                        }
