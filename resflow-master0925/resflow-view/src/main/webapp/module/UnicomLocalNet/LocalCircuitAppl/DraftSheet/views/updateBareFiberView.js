define(['module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/action/digitalCircutAction.js',
    'text!module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/templates/updateBareFiberView.html',
...
], function(digitalCircutAction,updateBareFiberView,i18n,css) {
    return fish.View.extend({
        template: fish.compile(updateBareFiberView),
