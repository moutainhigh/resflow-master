define(['module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/action/digitalCircutAction.js',
    ...
    return fish.View.extend({
        ...
        if (actType!="101" && actType!="107"){
            $('#ethernet-Form').validator('setIgnoreField', 'CUST_EMAIL,CUST_NAME_CHINESE,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME,CUST_TEL,CUST_MANAGER,CUST_MANAGER_TEL,HANDLE_TIME', true);
        }else{
            $('#ethernet-Form').validator('setIgnoreField', 'CUST_EMAIL,CUST_NAME_CHINESE,circuitCode,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME,CUST_TEL,CUST_MANAGER,CUST_MANAGER_TEL,HANDLE_TIME', true);
        }
        var checkNull = $("#ethernet-Form").isValid();
        if (actType!="101" && actType!="107"){
            $('#ethernet-Form').validator('setIgnoreField', 'CUST_EMAIL,CUST_NAME_CHINESE,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME,CUST_TEL,CUST_MANAGER,CUST_MANAGER_TEL,HANDLE_TIME', false);
        }else{
            $('#ethernet-Form').validator('setIgnoreField', 'CUST_EMAIL,CUST_NAME_CHINESE,circuitCode,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME,CUST_TEL,CUST_MANAGER,CUST_MANAGER_TEL,HANDLE_TIME', false);
        }
        if (!checkNull) {
        ...
        submit: function () {
            ...
            $('#ethernet-Form').validator('setIgnoreField', 'tradeId,serialNumber,circuitCode,slaFlag,requFineTime' +
