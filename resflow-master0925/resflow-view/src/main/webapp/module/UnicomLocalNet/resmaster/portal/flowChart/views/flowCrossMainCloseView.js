...
define(['module/UnicomLocalNet/resmaster/portal/flowChart/action/flowChartViewAction',
    'text!module/UnicomLocalNet/resmaster/portal/flowChart/templates/flowCrossMainClose.html',
    'i18n!module/UnicomLocalNet/resmaster/portal/i18n/portalView.i18n',
    'css!module/UnicomLocalNet/resmaster/portal/flowChart/styles/flowChart.css'
], function (flowChartVAction, flowCrossMainCloseView, i18n, css) {
    return fish.View.extend({
        ...
        dataSource: "",
        systemSource: "",
        template: fish.compile(flowCrossMainCloseView),
            ...
            flowChartVAction.qryParentSubStatusByOrderId(flowStatus,function (data) {
                ...
                if(data != ''
                    ...
                    fish.each(data, function (dataSub) {
                        if (dataSub.ORDER_STATE != '200000004'){
                            endFlg = false;
                        }
        ...
        tachClick :function($this,page, rowNum, sortname, sortorder){
            ...
            rowNum = rowNum || this.$("#crossMainView").grid("getGridParam", "rowNum");
            ...
            //调用后台方法
            $("#crossMainView").blockUI({message: '加载中'}).data('blockui-content', true);
            flowChartVAction.queryTaskInfoByTacheCode(param,function (res) {
                $("#crossMainView").unblockUI().data('blockui-content', false);
                $("#crossMainView").grid("reloadData", res.result);
        ...
        initTaskInfoGrid: function($this) {
            ...
            $("#crossMainView").grid("setGridHeight", 327);
        },
