    ...
    function (template, portalViewi18n, reportAction, cQreportAction,css) {
        ...
        return ngc.View.extend({
            ...
            initMultiselect:function(){
                ...
                cQreportAction.getOrgName(function (data) {
            ...
            initGrid: function () {
                ...
                $("#undoneTache-grid").grid({
                    ...
                    colModel: [
                        ...
                        {name: 'CD_ORG', label: '二干调度环节处理人所属分公司',width: 200, align: 'center', sortable: false},
                        {name: 'CD_STAFF', label: '二干调度环节处理人员/角色',width: 200, align: 'center', sortable: false},
