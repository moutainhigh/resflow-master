define(["text!module/UnicomLocalNet/resmaster/portal/orderWorkDeal/templates/applyCheck.html",
    ...
    function(template,portalViewi18n,operOrderAction,css) {
        return fish.View.extend({
            ...
            initialize: function() {
                ...
                URL = "";
                FILES = null; //附件
                userInfo = operOrderAction.queryStaffInfo().responseJSON.data; //用户信息
            ...
            submitOrder : function(params){
                ...
                operOrderAction.feedBackToOneDryBatch(params, function (res) {
                    $.unblockUI();
                    if (res.success) {
