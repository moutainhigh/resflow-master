...
define(['module/UnicomLocalNet/resmaster/portal/flowChart/action/flowChartViewAction',
    'text!module/UnicomLocalNet/resmaster/portal/flowChart/templates/localVerificationView.html',
    'i18n!module/UnicomLocalNet/resmaster/portal/i18n/portalView.i18n',
    'css!module/UnicomLocalNet/resmaster/portal/flowChart/styles/flowChart.css'
], function (flowChartVAction, localVerificationView, i18n, css) {
    return fish.View.extend({
        ...
        dataSource: "",
        systemSource: "",
        template: fish.compile(localVerificationView),
                ...
                if (data != ''
                    ...
                    fish.each(data, function (dataSub) {
                        if ('290000002' == dataSub.WO_STATE
                            ...
                            if('INVESTMENT_ESTIMATION' == dataSub.TACHE_CODE){
                                investEst = 2;
                            }
                            ...
                            if('CHECK_TOTAL' == dataSub.TACHE_CODE){
                                checkTo = 1;
                            }
                        }
                    });
                    if((investEst == 1 && checkTo == 1)
                        ...
                        $('#flowEndSub').addClass('fish-finish');
                    }
        ...
        tachClick :function($this,page, rowNum, sortname, sortorder){
            ...
            rowNum = rowNum || this.$("#localTaskInfo").grid("getGridParam", "rowNum");
            ...
            //调用后台方法
            $("#localTaskInfo").blockUI({message: '加载中'}).data('blockui-content', true);
            flowChartVAction.queryTaskInfoByTacheCode(param,function (res) {
                $("#localTaskInfo").unblockUI().data('blockui-content', false);
                $("#localTaskInfo").grid("reloadData", res.result);
        ...
        initTaskInfoGrid: function($this) {
            ...
            $("#localTaskInfo").grid("setGridHeight", 327);
        },
