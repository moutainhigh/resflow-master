    ...
    function (template, portalViewi18n, reportAction, css) {
        ...
        return ngc.View.extend({
            ...
            initDisDetailGrid: function () {
                ...
                $("#disOrderDetailStatistics-grid").grid({
                    ...
                    pageData: function (e, rowid, iRow, iCol) {
                        me.querydisOrderDetailStatisticsList(e, rowid, iRow, iCol);
                    }.bind(this),
                });
            },
            resize: function () {
            ...
            exportExcel: function () {
                ...
                reportAction.export(me.getRootPath() + '/localScheduleLT/ReportController/exportDisOrderDetailData.spr', param);
            },
            // 获取根目录
