    ...
    function (template, portalViewi18n, reportAction, css) {
        ...
        return ngc.View.extend({
            ...
            initDisDetailGrid: function () {
                ...
                $("#disOrder-grid").grid({
                    ...
                    colModel: [
                       ...
                       // {name: 'ORDER_ID', label: '订单ID', width: 200, hidden:true},
                        //{name: 'PS_ID', label: '流程实例', width: 200, hidden:true},
                        //{name: 'ORDER_IDS', label: '子流程定单ID合集', width: 200, hidden:true},
            ...
            queryDisOrderList: function (page, rowNum, isReject) {
                var me = this;
                var param={};
                param.operateType = me.options.operateType;
                param.productCode = me.options.productCode;
                param.endDate = me.options.endDate;
                param.beginDate = me.options.beginDate;
                ...
                reportAction.queryCircuitInfoForBusiReport(param, function (res) {
