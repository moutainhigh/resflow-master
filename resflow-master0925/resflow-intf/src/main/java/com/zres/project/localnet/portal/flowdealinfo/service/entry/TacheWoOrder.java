...
public class TacheWoOrder {
    ...
    enum TacheCode {
        ...
        SPECIALTY_RESOURCE_SUPPLEMENT_SEC("specialtyResourceSuppementTache"), //专业资源补录
        ALL_SPECIALTY_RESOURCE_SUPPLEMENT_SEC("allSpecialtyResourceSuppementTache"), //各专业资源补录
        LOCAL_SCHEDULE_RESOURCE_SUPPLEMENT_SEC("localScheduleResourceSuppementTache"); //本地调度资源补录
