...
public class FieldValue {
	...
	/** 哪行哪列 例如：B1列*/
	private String cellRowName;

	/** 下拉转换接口定义: 自定义实现(全类名) */
	private String cellDropDownConverterName;
	...
	public String getCellRowName() {
		return cellRowName;
	}

	public void setCellRowName(String cellRowName) {
		this.cellRowName = cellRowName;
	}

	public String getCellDropDownConverterName() {
		return cellDropDownConverterName;
	}

	public void setCellDropDownConverterName(String cellDropDownConverterName) {
		this.cellDropDownConverterName = cellDropDownConverterName;
	}
