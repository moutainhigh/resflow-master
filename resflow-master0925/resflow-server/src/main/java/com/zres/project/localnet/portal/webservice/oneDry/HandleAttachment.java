...
public class HandleAttachment extends Thread {
    ...
    public FtpConfigDto getFtpConfigInfo(String codeType) throws Exception { //获取FTP连接
        ...
        String sql1 = "select CODE_VALUE from GOM_BDW_CODE_INFO_SECOND where CODE_TYPE  = '" + codeType + "'and CODE_TYPE_NAME='ip'";
        String sql2 = "select CODE_VALUE from GOM_BDW_CODE_INFO_SECOND where CODE_TYPE  = '" + codeType + "'and CODE_TYPE_NAME='port'";
        String sql3 = "select CODE_VALUE from GOM_BDW_CODE_INFO_SECOND where CODE_TYPE  = '" + codeType + "'and CODE_TYPE_NAME='username'";
        String sql4 = "select CODE_VALUE from GOM_BDW_CODE_INFO_SECOND where CODE_TYPE  = '" + codeType + "'and CODE_TYPE_NAME='password'";
        String sql5 = "select CODE_VALUE,SORT_NO from GOM_BDW_CODE_INFO_SECOND where CODE_TYPE  = '" + codeType + "'and CODE_TYPE_NAME='directory'";
