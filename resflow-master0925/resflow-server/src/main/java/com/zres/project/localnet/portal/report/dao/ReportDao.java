...
public interface ReportDao {
     ...
     * @date 2019/5/20 : 17:11
     */
    List<Map<String, Object>> getAttrInfoBySrvId(@Param("srvOrdId") String srvOrdId);
 ...
 /**
     ...
     * @return
     */
    List<Map<String, Object>> queryCircuitInfoForBusiReport(Map<String, Object> param);

    int queryCountForBusiReport(Map<String, Object> param);
}
