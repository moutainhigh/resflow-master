    ...
    public void convertDrop(Sheet sheet, FieldValue fieldValue, DropType type, DataValidationHelper dvHelper) throws Exception {
        ...
        if(DropType.EXPORT.equals(type)){
                if("serviceName".equals(fieldValue.getName())){//产品类型
                    List<String> baseObjects = this.queryNameFromDb("product_code");
                    ...
                    List<String> baseObjects = this.queryNameFromDb("operate_type");
                    if (!CollectionUtils.isEmpty(baseObjects)) {
                        String[] strings = new String[baseObjects.size()];
                        baseObjects.toArray(strings);
                        this.setDropDownData(strings,sheet,cellRowName,dvHelper);
                    ...
                    List<String> baseObjects = this.queryNameFromDb("10000102");
                    if(!CollectionUtils.isEmpty(baseObjects)){
                        String[] strings = new String[baseObjects.size()];
                        baseObjects.toArray(strings);
//                        this.setDropDownData(strings,sheet,cellRowName,dvHelper);
                    ...
                    List<String> baseObjects = this.queryNameFromDb("10000516");
                    if(!CollectionUtils.isEmpty(baseObjects)){
                        String[] strings = new String[baseObjects.size()];
                        baseObjects.toArray(strings);
                        this.setDropDownData(strings,sheet,cellRowName,dvHelper);
                    ...
                    List<String> baseObjects = this.queryNameFromDb("10000513");
                    if(!CollectionUtils.isEmpty(baseObjects)){
                        String[] strings = new String[baseObjects.size()];
                        baseObjects.toArray(strings);
                        this.setDropDownData(strings,sheet,cellRowName,dvHelper);
                    ...
                    List<String> baseObjects = this.queryNameFromDb("10000514");
                    if(!CollectionUtils.isEmpty(baseObjects)){
                        String[] strings = new String[baseObjects.size()];
                        baseObjects.toArray(strings);
                        this.setDropDownData(strings,sheet,cellRowName,dvHelper);
                    ...
                    List<String> baseObjects = this.queryNameFromDb("10000515");
                    if(!CollectionUtils.isEmpty(baseObjects)){
                        String[] strings = new String[baseObjects.size()];
                        baseObjects.toArray(strings);
                        this.setDropDownData(strings,sheet,cellRowName,dvHelper);
                    ...
                    List<String> baseObjects = this.queryNameFromDb("CON0095");
                    if(!CollectionUtils.isEmpty(baseObjects)){
                        String[] strings = new String[baseObjects.size()];
                        baseObjects.toArray(strings);
                        this.setDropDownData(strings,sheet,cellRowName,dvHelper);
                    ...
                    List<String> baseObjects = this.queryNameFromDb("10000101");
                    if(!CollectionUtils.isEmpty(baseObjects)){
                        String[] strings = new String[baseObjects.size()];
                        baseObjects.toArray(strings);
 //                       this.setDropDownData(strings,sheet,cellRowName,dvHelper);
                    ...
                    List<String> baseObjects = this.queryNameFromDb("10000506");
                    if(!CollectionUtils.isEmpty(baseObjects)){
                        String[] strings = new String[baseObjects.size()];
                        baseObjects.toArray(strings);
   //                     this.setDropDownData(strings,sheet,cellRowName,dvHelper);
                    ...
                    List<String> baseObjects = this.queryNameFromDb("10000107");
                    if(!CollectionUtils.isEmpty(baseObjects)){
                        String[] strings = new String[baseObjects.size()];
                        baseObjects.toArray(strings);
                        this.setDropDownData(strings,sheet,cellRowName,dvHelper);
                    ...
                    List<String> baseObjects = this.queryNameFromDb("10000114");
                    if(!CollectionUtils.isEmpty(baseObjects)){
                        String[] strings = new String[baseObjects.size()];
                        baseObjects.toArray(strings);
                        this.setDropDownData(strings,sheet,cellRowName,dvHelper);
                    ...
                    List<String> baseObjects = this.queryNameFromDb("relayType");
                    if(!CollectionUtils.isEmpty(baseObjects)){
                        String[] strings = new String[baseObjects.size()];
                        baseObjects.toArray(strings);
                        //                       this.setDropDownData(strings,sheet,cellRowName,dvHelper);
    ...
    //模拟查询数据库
    private List<String> queryNameFromDb(String codeType){
