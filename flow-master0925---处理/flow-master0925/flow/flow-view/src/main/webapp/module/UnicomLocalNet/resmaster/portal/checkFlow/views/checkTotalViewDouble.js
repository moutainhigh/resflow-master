define(['text!module/UnicomLocalNet/resmaster/portal/checkFlow/templates/checkTotalViewDouble.html',
    ...
    return fish.View.extend({
        ...
        saveCheckInfo: function(){
            ...
            if (data.length >= 1) {
                ...
                param.formValue.A_RES_HAVE = $("#A_RES_HAVE").combobox("value");
                param.formValue.A_TOTAL_AMOUNT = $("#A_TOTAL_AMOUNT").val();
                param.formValue.A_LONGEST_PERIOD = $("#A_LONGEST_PERIOD").val();
