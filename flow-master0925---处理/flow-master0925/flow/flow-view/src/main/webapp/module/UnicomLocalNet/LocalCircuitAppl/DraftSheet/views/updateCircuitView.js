define(['module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/action/digitalCircutAction.js',
        'text!module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/templates/updateCircuitView.html',
    ...
    return fish.View.extend({
        ...
        initForm:function (actType) {
            if(actType=='101'){
                ...
                $("#sub_A_OldBelongRegion").hide();
                $("#sub_Z_oldBelongRegion").hide();
                $("#sub_A_OldBelongCounty").hide();
                $("#sub_A_OldInstalledAdd").hide();
                $("#sub_Z_OldBelongCounty").hide();
                $("#sub_Z_OldInstalledAdd").hide();
            }
        }
