...
define(function(){
    return {
         ...
         * @returns {*}
         */
        qrySrvOrdIdByInstanceId:function(instanceId,systemresouce,success){
        ...
        /**
         * 根据实例ID查询调度侧所有的关于该电路的记录,判断是否有在途单
         * @param param
         * @param success
         * @returns {*}
         */
        querySrvOrdStateByInstanceId:function(param, success){
            return  ngc.callServerFunction("com.zres.project.localnet.portal.resourceInitiate.service.ResourceInitiateServiceIntf","querySrvOrdStateByInstanceId",
                param,
                success);
        },
        /**
         * 根据实例ID查询是否有未完成的资源补录单
         * @param param
         * @param success
         * @returns {*}
         */
