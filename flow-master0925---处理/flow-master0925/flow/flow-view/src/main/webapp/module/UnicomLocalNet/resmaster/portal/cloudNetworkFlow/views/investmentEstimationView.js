 ...
 */
define([
    'text!module/UnicomLocalNet/resmaster/portal/cloudNetworkFlow/templates/investmentEstimationView.html',
...
], function (investmentEstimationView, cloudNetWorkResCheckFlowAction, operOrderAction, css) {
    return fish.View.extend({
        template: fish.compile(investmentEstimationView),
        events: {
        ...
        initColModel: function(){
            return [
                {name: 'CHECK_STATE', label: '投资估算', width: 95, sortable: false,
