define(['text!module/UnicomLocalNet/resmaster/portal/orderWorkDeal/templates/resConfigView.html',
    ...
    return fish.View.extend({
        ...
        render: function() {
            ...
            var me = this;
            if (me.options.psId == '1000211' ){ // 核查流程
                titleObj.TITLE = '资源核查';
                ...
                //if (me.options.tacheId == '500001157' || me.options.tacheId == '500001155'){ // 资源分配，光纤资源分配环节
                titleObj.TITLE = '资源配置';
        ...
        circuitInfo : function() {
            ...
            // 冻结表格复选框一列
            $("#circuitGrid , #circuitConfigGrid").grid('setFrozenColumns', 1);
        },
