define(['module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/action/digitalCircutAction.js',
    'text!module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/templates/updateDdnView.html',
...
], function(digitalCircutAction,updateDdnView,i18n,css) {
    return fish.View.extend({
        template: fish.compile(updateDdnView),
        i18nData: fish.extend({}, i18n),
        events: {
            'clickf #sub_save-button': 'sub_save',
        },
