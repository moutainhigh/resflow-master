define(['module/component/views/FormView',
    ...
    ,function (FormView, GridView,TreeView,prodApplyErganAction,userManage) {
        var templatehtml = '<div class="ui-dialog dialog-md" id="dialogMd" style="height: 540px;">'+
            ...
            '<li id="preciseCond"><a>'+userManage.LOCAL_PROD_ASSIGNMENT+'</a></li>'+
 ...
 */
        ...
        var popView = ngc.View.extend({
            ...
            afterRender: function () {
                ...
                var param = {entity:{id:userId,typeId:this.options.config.resultData.typeId }};

                $.when(userId?prodApplyErganAction.queryProdGroupAssingInfo(userId.toString(), '1', $.noop):$.noop,
                    userId?prodApplyErganAction.queryProdGroupAssingInfo(userId.toString(), '2', $.noop):$.noop,
            ...
            saveRoleGroup:function(){
                ...
                if(girdData.length>0){
                    ...
                    prodApplyErganAction.saveProdGroup(jsonObj, function(resultData){
                        that.progressOff();
            ...
            /*saveRoleGroup:function(){
                ...
                prodApplyErganAction.saveProdGroup(jsonObj,function(data){
                    that.progressOff();
                    debugger;
                    if(data.flag == true){
                        that.trigger("rolesChanged",true);
