define(['text!module/UnicomLocalNet/resmaster/portal/checkFlow/templates/specialtyCheckViewSingle.html',
...
], function(operOrderView, operOrderAction, orderStandbyAction, orderDetailsAction, i18n) {
    let srvOrdIds;
    let userInfo;
    let sysResource;
    let meOpera;
