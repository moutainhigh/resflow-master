/**
 * 静态流程图展示页面- 本地客户电路新开、变更、移机流程
 */
define(['module/UnicomLocalNet/resmaster/portal/flowChart/action/flowChartViewAction',
    'text!module/UnicomLocalNet/resmaster/portal/flowChart/templates/flowChartLocalCustomView.html',
    'i18n!module/UnicomLocalNet/resmaster/portal/i18n/portalView.i18n',
    'css!module/UnicomLocalNet/resmaster/portal/flowChart/styles/flowChart.css'
], function (flowChartVAction,flowChartLocalCustomView, i18n, css) {
    return fish.View.extend({
        ...
        dataSource: "",
        systemSource: "",
        template: fish.compile(flowChartLocalCustomView),
        ...
        afterRender: function () {
            ...
            if('flow-schedule-lt' == this.systemSource){
                if('localBuild' == this.dataSource){
                    ...
                    $("#START_RENT").children('.fish-flowName').text("集客起租");
                }else if('onedry' == this.dataSource){
                    $("#onedryFlow").css('display','block');
                    $("#oneStern").css('display','block');
                    $("#START_RENT").children('.fish-flowName').text("一干起租");
                }
                ...
                if(data != ''
                    ...
                    fish.each(data, function (dataSub) {
                        if('290000002' == dataSub.WO_STATE
                            || '290000111' == dataSub.WO_STATE || '290000119' == dataSub.WO_STATE){ //执行中
