        ...
        return ngc.View.extend({
            ...
            afterRender: function() {
                ...
                for (var i = 0; i < selArrrow.length; i++) {
                    ...
                    regionId[i]  = this.options.selArrrow[i].REGION_ID;
                    woId[i]  = this.options.selArrrow[i].WO_IDS;
                }
            ...
            fileUpload:function () {
                ...
                debugger
                this.jsonSelarrrow = JSON.stringify(selarrrowCollSub);
                ...
                if(fileLength != 0){
                    ...
                    this.fileList.url = this.URl+"/localScheduleLT/orderStandbyController/uploadFiles.spr";
                    // debugger;
                ...
                $('.js-select-file').fileupload({
                    ...
                    add: function (e, data) {
                        ...
                        $('.file-remove').off('click').on('click', function (e) {
                            ...
                            $.each(this.fileList.files, function (index, file) {
                                if (file.name === name) {
                                    pos = index;
                                    return false;
                                }
