    ...
    function(template,portalViewi18n,qryAction) {
        ...
        var MainView = ngc.View.extend({
            ...
            events:{
                ...
                'click #secondSystem':'secondSystem',
            ...
            afterRender : function() {
                ...
                //判断是否是海南重庆用户
                if('重庆' == userInfo.areaName || '海南省' ==  userInfo.areaName){
                    this.$("#secondSystem").hide();
                }else{
                    this.$("#secondSystem").show();
                }
                //校验是否是管理员
            ...
            secondSystem:function (e) {
                //后台获取配置二干地址
                var url = qryAction.queryUrl("secondSystem").responseJSON.data;
                window.open(url,"_blank");
            },
