define(['module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/action/digitalCircutAction.js',
    'text!module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/templates/ethernetView.html',
...
], function(digitalCircutAction,ethernetView,i18n,css) {
    var $grid;
    var productType;
    var productTypeText;
    ...
    return fish.View.extend({
        ...
        template: fish.compile(ethernetView),
        ...
        initGred:function (mydata) {
            ...
            var opt = {
                ...
                colModel: [
                    ...
                    {name: 'serialNumber', label: '业务号码', width: 110, sorttype: "string", align: "center",},
                    ...
                    {name: 'circuitReqName', label: '电路要求', width: 110, sorttype: "string", align: "center",},
                    {name: 'circuitCode', label: '电路编号', width: 110, sorttype: "string", align: "center",},
                    {name: 'oldCircuitCode', label: '原电路编号', width: 110, sorttype: "string", align: "center",hidden:true},
                    {name: 'speed', label: '带宽', width: 1, sorttype: "string", align: "center", hidden: true},
                    {name: 'speedName', label: '带宽', width: 110, sorttype: "string", align: "center",},
                    {name: 'custManager', label: '客户经理', width: 110, sorttype: "string", align: "center",},
                    {name: 'custManaPhone', label: '客户经理联系电话', width: 200, sorttype: "string", align: "center",},
                    {name: 'requFineTime', label: '全程要求完成时间', width: 200, sorttype: "string", align: "center",},
                    //{name: 'accepTime', label: '受理时间', width: 200, sorttype: "string", align: "center",},
                    {name: 'createTime', label: '创建时间', align: "center", width: 200, sorttype: "string",},
                    ...
                    {name: 'VLANMode', label: 'VLAN模式', width: 1, sorttype: "string", align: "center", hidden: true},
                    {name: 'VLAN', label: 'VLAN号', width: 1, sorttype: "string", align: "center", hidden: true},
                    {
                        name: 'AConvServiceNum',
                        label: 'A端汇聚电路业务号码',
                        width: 1,
                        sorttype: "string",
                        align: "center",
            ...
            $grid.on('click', '.js-delete', function () {
                ...
                var popup = fish.popupView({
                    url: 'module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/views/updateEthernetView',
                    width: "95%",
                    height: "90%",
                    modal: true,
                    canClose: true,
            ...
            //添加电路按钮
             $("#addAndSelectRow").off('click').on('click',function(e) {
                ...
                if (actType!="101" && actType!="107"){
                    $('#ethernet-Form').validator('setIgnoreField', 'CUST_EMAIL,CUST_NAME_CHINESE,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME,CUST_TEL', true);
                }else{
                    $('#ethernet-Form').validator('setIgnoreField', 'CUST_EMAIL,CUST_NAME_CHINESE,circuitCode,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME,CUST_TEL', true);
                }
                var checkNull = $("#ethernet-Form").isValid();
                if (actType!="101" && actType!="107"){
                    $('#ethernet-Form').validator('setIgnoreField', 'CUST_EMAIL,CUST_NAME_CHINESE,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME,CUST_TEL', false);
                }else{
                    $('#ethernet-Form').validator('setIgnoreField', 'CUST_EMAIL,CUST_NAME_CHINESE,circuitCode,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME,CUST_TEL', false);
                }
                if (!checkNull) {
        ...
        queryWorkOrders: function (page, rowNum, sortname, sortorder) {
            ...
            //获取表单信息
            var formValue = $('#ethernet-Form').form("value");
        ...
        submit: function () {
            ...
            $('#ethernet-Form').validator('setIgnoreField', 'tradeId,serialNumber,circuitCode,A_belong_region,Z_belong_region,requFineTime' +
                ',speed,cirLeaseRange,cirUse,A_belong_province,A_belong_city,Z_belong_province,Z_belong_city,A_installed_add,A_contact_man' +
                ',A_contact_tel,Z_contact_man,Z_contact_tel,A_interface_type,Z_interface_type,Z_installed_add', true);
            var checkNull = $("#ethernet-Form").isValid();
            $('#ethernet-Form').validator('setIgnoreField', 'tradeId,serialNumber,circuitCode,A_belong_region,Z_belong_region,requFineTime' +
                ',speed,cirLeaseRange,cirUse,A_belong_province,A_belong_city,Z_belong_province,Z_belong_city,A_installed_add,A_contact_man' +
                ',A_contact_tel,Z_contact_man,Z_contact_tel,A_interface_type,Z_interface_type,Z_installed_add', false);
            if (!checkNull) {
                // fish.toast("success","");
                fish.error({title: '提示', message: '请检查必填数据或数据格式'})
                return;
            ...
            var _this = this;
            $("#ethernet-Form").blockUI({message: '请稍后...'}).data('blockui-content', true);
            ...
            digitalCircutAction.orderInfoSubmit(orderInfoObj, function (data) {
                ...
                if (arrdata[0] == 'success') {
                    ...
                    // fish.toast("success","");
                    $("#ethernet-Form").unblockUI().data('blockui-content', false);
                    _this.popup.close();
                } else {
                    $("#ethernet-Form").unblockUI().data('blockui-content', false);
        ...
        save: function () {
            ...
            var _this = this;
            $("#ethernet-Form").blockUI({message: '保存中'}).data('blockui-content', true);
