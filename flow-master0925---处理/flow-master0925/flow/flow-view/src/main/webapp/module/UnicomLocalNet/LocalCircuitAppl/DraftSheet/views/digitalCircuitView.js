            ...
            var me = this;
             $("#addAndSelectRow").off('click').on('click',function(e) {
                ...
                if (actType!="101" && actType!="107"){
                    $('#digitalCir-Form').validator('setIgnoreField','CUST_EMAIL,CUST_NAME_CHINESE,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME,CUST_TEL',true);//取消非电路信息的字段校验
                }else{
                    $('#digitalCir-Form').validator('setIgnoreField','CUST_EMAIL,CUST_NAME_CHINESE,circuitCode,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME,CUST_TEL',true);//取消非电路信息的字段校验
                }
                var checkNull = $("#digitalCir-Form").isValid();
                if (actType!="101" && actType!="107"){
                    $('#digitalCir-Form').validator('setIgnoreField','CUST_EMAIL,CUST_NAME_CHINESE,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME,CUST_TEL',false);//取消非电路信息的字段校验
                }else{
                    $('#digitalCir-Form').validator('setIgnoreField','CUST_EMAIL,CUST_NAME_CHINESE,circuitCode,HANDLE_CITY,HANDLE_MAN_NAME,HANDLE_MAN_TEL,HANDLE_DEP,CUST_CONTACT_MAN_NAME,CUST_TEL',false);//取消非电路信息的字段校验
                }
                if(!checkNull){
...
*/
        ...
        submit:function () {
            ...
            $('#digitalCir-Form').validator('setIgnoreField', 'tradeId,serialNumber,circuitCode,A_belong_region,Z_belong_region' +
