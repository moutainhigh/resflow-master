define(['text!module/UnicomLocalNet/resmaster/portal/checkFlow/templates/checkTotalView.html',
    ...
    return fish.View.extend({
        ...
        initCheckInfo : function (param) {
            ...
            if(checkFlag) {
                ...
                // 接入工建系统的省份，已经下发工建，展示工建反馈信息
                var params = {};
                params.orderId = param.ORDER_ID;
                var ifFlag = orderDetailsAction.showEnginInfo(params).responseJSON.data;
                if (ifFlag){
                    $("#enginBackA").show();
                    $("#enginBackA2").show();
                    $("#enginBackZ").show();
        ...
        queryCheckInfo : function (param) {
            ...
            operOrderAction.queryCheckInfo(params,function (res) {
                ...
                for(var key in arrayData){
                    ...
                    var keyArray = new Array("A_RES_SATISFY","Z_RES_SATISFY","A_RES_PROVIDE","Z_RES_PROVIDE","A_RES_ACCESS","Z_RES_ACCESS","A_EQUIP_READY","Z_EQUIP_READY");
                ...
                if(param.SERVICE_ID=="10000011"){
                    $("#DEV_COST_Z").val($("#DEV_COST_A").val());
                    $("#OPT_COST_Z").val($("#OPT_COST_A").val());
                    $("#OTHER_COST_Z").val($("#OTHER_COST_A").val());
                }
            });
        },
        // 查询电路信息
