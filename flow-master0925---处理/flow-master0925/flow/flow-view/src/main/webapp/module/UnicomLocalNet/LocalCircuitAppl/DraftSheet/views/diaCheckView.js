define(['module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/action/digitalCircutAction.js',
    'text!module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/templates/diaCheckView.html',
...
], function(digitalCircutAction,diaCheckView,i18n,css) {
    var $grid;
    var productType;
    var productTypeText;
    var actType;
    ...
    return fish.View.extend({
        ...
        template: fish.compile(diaCheckView),
        ...
        initGred:function (mydata) {
            ...
            $grid.on('click', '.js-delete', function() {
                ...
                var popup = fish.popupView({
                    url: 'module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/views/updateDiaCheckView',
                    width: "95%",
                    height:"90%",
                    modal:true,
                    canClose:true,
