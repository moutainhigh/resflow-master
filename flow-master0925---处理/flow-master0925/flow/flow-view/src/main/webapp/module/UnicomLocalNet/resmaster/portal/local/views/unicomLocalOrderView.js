define([
 ...
 function(unicomLocalOrderAction,unicomLocalOrderView,i18n,css) {
    ...
    return fish.View.extend({
        ...
        initialize: function() {
            this.render();
            fish.store.set("isLocalUnicom","localBuild");//默认本地
        ...
        afterRender: function() {
            ...
            $('#itemTypeStart').on('combobox:change',function () {
                ...
                //产品类型
                unicomLocalOrderAction.queryProdTypeLocal(productTypeObj,function(data) {
        ...
        startLocalApplyFun:function(){
            ...
            if(itemTypeStart.value=='102'){
                //modify by wang.gang2 ZMP 2032875 互联网专线是一端的不存在AZ端
                if("10000011" == productTypeStart.value){
                    me.openLocalDraftItemView('module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/views/diaCheckView',
                        productTypeStart,
                        actTypeStart,
                        'startorder',
                        'start',
        ...
        draftEditBtn:function(){
            ...
            if('102' == selrow.itemType){
                //modify by wang.gang2 ZMP 2032875 互联网专线是一端的不存在AZ端
                if("10000011" == selrow.prodBustType){
                    me.openLocalDraftItemView('module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/views/diaCheckView',
                        productTypeEdit,
                        actTypeEdit,
                        'draftorder',
        ...
        draftDeleteBtn:function(){
            ...
            fish.confirm("确认删除该草稿单?").result.then(function(){
                unicomLocalOrderAction.delDraftInfo(selrow.cstOrdId,selrow.srvordIds,function (data) {
                    //删除后重新查询
                    if (data == "success"){
        ...
        resize: function() {
            ...
            $("#localConfig-localdraftGrid").grid("setGridHeight", frameHeight - 307);
        }
