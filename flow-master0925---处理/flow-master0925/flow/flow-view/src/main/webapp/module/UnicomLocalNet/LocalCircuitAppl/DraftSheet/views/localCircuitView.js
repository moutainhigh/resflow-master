define(['module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/action/digitalCircutAction.js',
    'text!module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/templates/localCircuitView.html',
...
], function(digitalCircutAction,localCircuitView,i18n,css) {
    var $grid;
    var productType;
    var productTypeText;
    var actType;
    ...
    return fish.View.extend({
        ...
        template: fish.compile(localCircuitView),
        ...
        initCombobox:function(){
            ...
            for(var i =0;i<menu.length;i++){
                ...
                if(enumType=='10000506'){
                    digitalCircutAction.queryEnum2(enumType,function (data) {
                        var array = new Array();
                        array =data;
        ...
        initTree:function () {
            ...
            $("#addAllRow").click(function() {
                var _this = $(this);
                var options = {
                    url: 'module/UnicomLocalNet/LocalCircuitAppl/AreaCombotree/views/batchOperPop',
                    height: '50%',
                    width: '60%',
                    modal: false,
                    draggable: true,
                    ...
                    callback: function (popup, view) {
                        popup.result.then(function (res) {
                            ...
                            if(res.message=="fail"){
                                fish.warn("导入电路失败，请检查导入EXCEL数据是否准确："+res.error);
                                return;
                            }
                            var data = res.data;
                            var retDatas = [];
                            for(var i = 0;i<100;i++){
                                if(data[i] == null){
                                    ...
                                    retData.tradeId = data[i].tradeId;
                                    retData.serviceName = data[i].serviceName;
                                    retData.serviceId= data[i].serviceId;
                                    retData.speedName = data[i].speedName;
                                    retData.speed = data[i].speed;
                                    retData.cirUseName = data[i].cirUseName;
                                    retData.cirUse = data[i].cirUse;
                                    retData.cirLeaseRange = data[i].cirLeaseRange;
                                    retData.cirLeaseRangeName = data[i].cirLeaseRangeName;
                                    retData.proPriDeg = data[i].proPriDeg;
                                    //retData.proPriDegName = data[i].proPriDegName;
                                    retData.RelayType = data[i].relayType;
                                    retData.RelayTypeName = data[i].relayTypeName;
                                    retData.requFineTime = data[i].requFineTimeStr;
                                    retData.custManager = data[i].custManager;
                                    retData.custManaPhone = data[i].custManaPhone;
                                    retData.slaFlag = data[i].slaFlag;
                                    retData.slaServOpen = data[i].slaServOpen;
                                    retData.count = data[i].count;


                                    //retData.slaServOpenName = data[i].slaServOpenName;
                                    retData.slaNetQuAss = data[i].slaNetQuAss;
                                    //retData.slaNetQuAssName = data[i].slaNetQuAssName;
                                    retData.slaSaleServ = data[i].slaSaleServ;
                                    //retData.slaSaleServName = data[i].slaSaleServName;
                                    //retData.A_belong_provinceName = data[i].a_belong_province;
                                    retData.A_belong_province = data[i].a_belong_provinceName;
                                    //retData.A_belong_cityName = data[i].a_belong_city;
                                    retData.A_belong_city = data[i].a_belong_cityName;
                                    //retData.A_belong_countyName = data[i].a_belong_county;
                                    retData.A_belong_county = data[i].a_belong_countyName;
                                    retData.A_belong_region_id = data[i].a_belong_region;
                                    retData.A_belong_region = data[i].a_belong_regionName;
                                    retData.A_customer_name = data[i].a_customer_name;
                                    //data[i].A_interface_type_Name = data[i].A_interface_type_Name;
                                    retData.A_interface_type = data[i].a_interface_type;
                                    retData.A_contact_man = data[i].a_contact_man;
                                    retData.A_contact_tel = data[i].a_contact_tel;
                                    retData.A_customer_manager = data[i].a_customer_manager;
                                    retData.A_customer_manager_tel = data[i].a_customer_manager_tel;
                                    retData.A_installed_add = data[i].a_installed_add;
                                    //retData.Z_belong_provinceName = data[i].z_belong_province;
                                    retData.Z_belong_province = data[i].z_belong_provinceName;
                                    //retData.Z_belong_cityName = data[i].z_belong_city;
                                    retData.Z_belong_city = data[i].z_belong_cityName;
                                    //retData.Z_belong_countyName = data[i].z_belong_county;
                                    retData.Z_belong_county = data[i].z_belong_countyName;
                                    retData.Z_belong_region_id = data[i].z_belong_region;
                                    retData.Z_belong_region = data[i].z_belong_regionName;
                                    retData.Z_customer_name = data[i].z_customer_name;
                                    //retData.Z_interface_typeName = data[i].Z_interface_typeName;
                                    retData.Z_interface_type = data[i].z_interface_type;
                                    retData.Z_contact_man = data[i].z_contact_man;
                                    retData.Z_contact_tel = data[i].z_contact_tel;
                                    retData.Z_customer_manager = data[i].z_customer_manager;
                                    retData.Z_customer_manager_tel = data[i].z_customer_manager_tel;
                                    retData.Z_installed_add = data[i].z_installed_add;
                                    retData.A_Room = data[i].a_room;
                                    retData.Z_Room = data[i].z_room;
                                    retData.IPv6 = data[i].iPv6;
                                    retData.IPv4 = data[i].custApplIPV4Count;
                                    retData.createTime = $("#createTime").val();
                                    retData.cir_remark = data[i].remark;
                                    var circuitReqName = $("#circuitReq").combobox('text');
                                    var circuitReq =$("#circuitReq").val();
                                    retData.circuitReqName = circuitReqName;
                                    retData.circuitReq = circuitReq;
                                    var circuitCode =$("#circuitCode").val();
                                    retData.circuitCode = circuitCode;
                                    retDatas[i] = retData;

                                }
                                //   var rowid = newData.id;
                                //$grid.grid("addRowData", retData);
                                //$grid.grid("setSelection", retData);
                                //$("input[name$='A_belong_province']").popedit('setValue', {name:data3.a_belong_provinceName, value:data3.a_belong_province});
                            }
                            $("#gridId").grid("addRowData",1, retDatas, 'last');
                        }, function (e) {
                            console.log('关闭了', e);
                        });
                    }
                ...
                open:function(e) {
                    ...
                    var options = {
                        ...
                        viewOption: {
                            flag : "org",
                            productType :productType,
                            orderType:me.options.itemTypeStart //单据类型
                        },
                        ...
                        var options = {
                            ...
                            callback: function (popup, view) {
                                popup.result.then(function (res) {
                                    ...
                                    _this.popedit('setValue', {name:orgNames, value:orgNames, objType:objType,phone:phone});
                                    $("#HANDLE_MAN_TEL").val(phone);
                                }, function (e) {
                                    console.log('关闭了', e);
                                });
                            }
            ...
            //选择审核人
            var userInfo = digitalCircutAction.queryStaffInfo().responseJSON.data; //用户信息
            $("#AUTIT_NAME").popedit({
                open:function(e) {
                    var _this = $(this);
                    var options = {
        ...
        initGred:function (mydata) {
            ...
            var opt = {
                ...
                colModel: [
                    ...
                    {name: 'serviceName',label: '产品类型',width: 110,sorttype: "string",align:"center",},
                    ...
                    {name: 'serialNumber',label: '业务号码',width: 100,sorttype: "string",align:"center",hidden:true},

                    { name: 'oldCircuitCode',label: '原电路编号',width: 100, sorttype: "string",align:"center",hidden:true},
                    {name: 'speed',label: '带宽',width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'speedName',label: '带宽',width: 100,sorttype: "string",align:"center",},
                    {name: 'count',label: '数量',width: 100,sorttype: "string",align:"center",},
                    {name: 'RelayType',label: '中继类型',width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'RelayTypeName',label: '中继类型',width: 100,sorttype: "string",align:"center",},
                    {name: 'cirLeaseRange',label: '电路租用范围',width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'cirLeaseRangeName',label: '电路租用范围',width: 100,sorttype: "string",align:"center",},
                    {name: 'cirUse',label: '电路用途',width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'cirUseName',label: '电路用途',width: 100,sorttype: "string",align:"center",},
                    ...
                    {name: 'A_Room', label: 'A端机房/放置点', width: 1,sorttype: "string",align:"center",hidden:true},
                    ...
                    {name: 'A_interface_type', label: 'A端-接口类型', width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'A_ServPort', label: 'A端-业务端口', width: 1,sorttype: "string",align:"center",hidden:true},
                    ...
                    {name: 'A_OldRoom', label: 'A端原机房/放置点', width: 1,sorttype: "string",align:"center",hidden:true},
                    ...
                    {name: 'Z_Room', label: 'Z端机房/放置点', width: 1,sorttype: "string",align:"center",hidden:true},
                    ...
                    {name: 'Z_interface_type', label: 'Z端-接口类型', width: 1,sorttype: "string",align:"center",hidden:true},
                    {name: 'Z_ServPort', label: 'Z端-业务端口', width: 1,sorttype: "string",align:"center",hidden:true},
                    ...
                    {name: 'Z_OldRoom', label: 'Z端原机房/放置点', width: 1,sorttype: "string",align:"center",hidden:true},
                    ]
            };
            ...
            $grid.on('click', '.js-delete', function() {
                ...
                var popup = fish.popupView({
                    url: 'module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/views/updateLocalCircuitView',
                    width: "95%",
                    height:"90%",
                    modal:true,
                    canClose:true,
            ...
            $("#addAndSelectRow").off('click').on('click',function(e) {
                ...
                if (actType!="101" && actType!="107"){
                    $('#localCircuit-Form').validator('setIgnoreField','HANDLE_CITY,HANDLE_MAN_TEL,HANDLE_MAN_NAME,HANDLE_DEP,APPLY_ORD_NAME,AUTIT_NAME',true);//取消非电路信息的字段校验
                }else{
                    $('#localCircuit-Form').validator('setIgnoreField','circuitCode,HANDLE_CITY,HANDLE_MAN_TEL,HANDLE_MAN_NAME,HANDLE_DEP,APPLY_ORD_NAME,AUTIT_NAME',true);//取消非电路信息的字段校验
                }
                var checkNull = $("#localCircuit-Form").isValid();
                if (actType!="101" && actType!="107"){
                    $('#localCircuit-Form').validator('setIgnoreField','HANDLE_CITY,HANDLE_MAN_TEL,HANDLE_MAN_NAME,HANDLE_DEP,APPLY_ORD_NAME,AUTIT_NAME',false);//取消非电路信息的字段校验
                }else{
                    $('#localCircuit-Form').validator('setIgnoreField','circuitCode,HANDLE_CITY,HANDLE_MAN_TEL,HANDLE_MAN_NAME,HANDLE_DEP,APPLY_ORD_NAME,AUTIT_NAME',false);//取消非电路信息的字段校验
                }
                if(!checkNull){
                ...
                digitalCircutAction.checkCircuitCode(param, function(res){
                        if(res.success){
                            ...
                            var circuitInfo = {};
                            var circuitCodeArea =['serviceId','circuitReq','circuitCode','serialNumber','oldCircuitCode','speed','count','RelayType','cirLeaseRange','cirUse','requFineTime','createTime',"serviceName","circuitReqName","speedName","cirUseName","cirLeaseRangeName", 'cir_remark', 'A_belong_province', 'A_belong_city', 'A_belong_county', 'A_belong_region', 'A_Room', 'A_contact_man', 'A_contact_tel', 'A_interface_type', 'A_ServPort', 'A_old_belong_region', 'A_old_belong_county', 'A_OldRoom', 'Z_belong_province', 'Z_belong_city', 'Z_belong_county', 'Z_belong_region', 'Z_Room', 'Z_contact_man', 'Z_contact_tel', 'Z_interface_type', 'Z_ServPort', 'Z_old_belong_region', 'Z_old_belong_county', 'Z_OldRoom','RelayTypeName','A_belong_region_id','Z_belong_region_id','A_old_belong_region_id','Z_old_belong_region_id','INSTANCE_ID','A_belong_city_id','Z_belong_city_id'];
                            ...
                            for(var i=0;i<circuitCodeArea.length;i++){
                                ...
                                if("cirUseName"==circuitCodeArea[i]){
                                    var key = circuitCodeArea[i];
                                    var value = $("#cirUse").combobox('text');
                                    circuitInfo[""+key]=""+value;
                                }
                                if("cirLeaseRangeName"==circuitCodeArea[i]){
                                    var key = circuitCodeArea[i];
                                    var value = $("#cirLeaseRange").combobox('text');
                                    circuitInfo[""+key]=""+value;
                                }
                                if ("RelayTypeName" ==circuitCodeArea[i]){
                                    var key = circuitCodeArea[i];
                                    var value = $("#RelayType").combobox('text');
                                    circuitInfo[""+key]=""+value;
                                }
                                ...
                                if("Z_belong_region_id"==circuitCodeArea[i]){
                                    var key = circuitCodeArea[i];
                                    if($("#Z_belong_region").popedit('getValue').value!=undefined){
        ...
        initPageParam:function () {
            ...
            document.getElementById('HANDLE_MAN_TEL').innerHTML="111111111111111111111";
            $("#circuitCode").change(function () {
                $("#oldCircuitCode").val($("#circuitCode").val());
            });
            //新开数量可选。非新开禁用
            if(actType=='101'){
                $("#count").spinner('enable');
            }else{
                $("#count").spinner('disable');
            }
            $('#addAllRow').hide();
            if(actType=="101"){
                $('#addAllRow').show();
                ...
                $("#A_old_belong_region_div").hide();
                $("#Z_old_belong_region_div").hide();
                $("#A_old_belong_county_div").hide();
                $("#Z_old_belong_county_div").hide();
                $("#A_OldRoom_div").hide();
                $("#Z_OldRoom_div").hide();
        ...
        initDigPage:function () {
            ...
            var orderType = this.options.itemTypeStart;
        ...
        querySelectedInf :function(CustId){
            ...
            digitalCircutAction.querySelectedInfo(params, function(data){
                ...
                for (var item in srvOrdDataJson){
                    ...
                    if(item == "AUTIT_NAME"){
                        var autitId=srvOrdDataJson['AUTIT_ID'].split("_J!G@F_");
                        $('#AUTIT_NAME').popedit('setValue', {name:srvOrdDataJson['AUTIT_NAME'],objType:autitId[0], value:autitId[1]});
                    }
                }
        ...
        queryWorkOrders: function(page, rowNum, sortname, sortorder) {
            ...
            //获取表单信息
            var formValue = $('#localCircuit-Form').form("value");
        ...
        submit:function () {
            ...
            $('#localCircuit-Form').validator('setIgnoreField','circuitCode,count,A_belong_region,Z_belong_region' +
                ',speed,cirLeaseRange,cirUse,A_belong_province,A_belong_city,Z_belong_province,Z_belong_city,A_contact_man' +
                ',A_contact_tel,A_interface_type,Z_contact_man,Z_contact_tel,Z_interface_type,requFineTime',true);//取消非电路信息的字段校验
            var checkNull = $("#localCircuit-Form").isValid();
            $('#localCircuit-Form').validator('setIgnoreField','circuitCode,count,A_belong_region,Z_belong_region' +
                ',speed,cirLeaseRange,cirUse,A_belong_province,A_belong_city,Z_belong_province,Z_belong_city,A_contact_man' +
                ',A_contact_tel,A_interface_type,Z_contact_man,Z_contact_tel,Z_interface_type,requFineTime',false);
            if(!checkNull){
                fish.error({title:'提示',message:'请检查必填数据或数据格式'})
                return;
            }
            ...
            formValue.AUTIT_NAME=$("#AUTIT_NAME").popedit('getValue').name;
            formValue.AUTIT_ID=$("#AUTIT_NAME").popedit('getValue').objType+'_J!G@F_'+$("#AUTIT_NAME").popedit('getValue').value;
            ...
            var _this =this;
            $("#localCircuit-Form").blockUI({message: '请稍后...'}).data('blockui-content', true);
            ...
            digitalCircutAction.orderInfoSubmit(orderInfoObj,function(data) {
                ...
                if(arrdata[0]=='success'){
                    ...
                    // fish.toast("success","");
                    $("#localCircuit-Form").unblockUI().data('blockui-content', false);
                    _this.popup.close();
                }else{
                    $("#localCircuit-Form").unblockUI().data('blockui-content', false);
        ...
        save:function () {
            ...
            var _this =this;
            $("#localCircuit-Form").blockUI({message: '保存中'}).data('blockui-content', true);
        ...
        UpdateSave : function(){
            ...
            $('#localCircuit-Form').validator('setIgnoreField', 'circuitCode,count,A_belong_region,Z_belong_region' +
                ',speed,cirLeaseRange,cirUse,A_belong_province,A_belong_city,Z_belong_province,Z_belong_city,A_contact_man' +
                ',A_contact_tel,A_interface_type,Z_contact_man,Z_contact_tel,Z_interface_type,requFineTime', true);
            var checkNull = $('#localCircuit-Form').isValid();
            $('#localCircuit-Form').validator('setIgnoreField','circuitCode,count,A_belong_region,Z_belong_region' +
                ',speed,cirLeaseRange,cirUse,A_belong_province,A_belong_city,Z_belong_province,Z_belong_city,A_contact_man' +
                ',A_contact_tel,A_interface_type,Z_contact_man,Z_contact_tel,Z_interface_type,requFineTime',false);
