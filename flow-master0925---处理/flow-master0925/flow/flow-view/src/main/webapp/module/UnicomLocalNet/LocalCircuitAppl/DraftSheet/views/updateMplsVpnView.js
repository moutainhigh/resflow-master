    ...
    return fish.View.extend({
        ...
        initTree:function (arrayData,actType) {
            ...
            for ( var key in arrayData) {
                ...
                var ifNeed = false;
                var keyCodeEmnu = 'Z_belong_province, Z_belong_county, Z_belong_region, Z_interface_type,Z_installed_add, A_belong_province, A_belong_county, A_belong_region, A_interface_type, A_installed_add';
                if (key.indexOf(keyCodeEmnu)) {
                    ifNeed = true;
                    if (key == 'Z_belong_province'){
                        key = 'CE_BelongProv';
