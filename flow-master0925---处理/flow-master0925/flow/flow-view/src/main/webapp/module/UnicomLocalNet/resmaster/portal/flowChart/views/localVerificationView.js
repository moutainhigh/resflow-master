                ...
                if (data != ''
                    ...
                    fish.each(data, function (dataSub) {
                        if ('290000002' == dataSub.WO_STATE|| '290000111' == dataSub.WO_STATE) { //执行中
                            ...
                            if('SEND_ENGINEERING' == dataSub.TACHE_CODE){
                                sendEngeering = 2;
                                $("#SEND_ENGINEERING").addClass('fish-dispose');
                            }
                            ...
                            if('SEND_ENGINEERING' == dataSub.TACHE_CODE){
                                sendEngeering = 1;
                                $("#SEND_ENGINEERING").addClass('fish-finish');
                            }
                        }
                    });
                    if(((checkT == 1&&invEst ==1)
                        ||(checkT == 1&&invEst == 0))&&sendEngeering!=2){
