define(['module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/action/digitalCircutAction.js',
    'text!module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/templates/updateEthernetView.html',
...
], function(digitalCircutAction,updateEthernetView,i18n,css) {
    return fish.View.extend({
        template: fish.compile(updateEthernetView),
