define(['module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/action/digitalCircutAction.js',
    'text!module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/templates/updateAtmView.html',
...
], function(digitalCircutAction,updateAtmView,i18n,css) {
    return fish.View.extend({
        template: fish.compile(updateAtmView),
        ...
        sub_save:function () {
            ...
            /*校验业务订单号和业务号码
            if (newAdd){
                $.blockUI({message: '校验业务订单号和业务号码中...'});
                var newAddObj = new Object();
                newAddObj.tradeId = formValue.tradeId;
                newAddObj.serialNumber = formValue.serialNumber;
                newAddObj.actType = actType;
                var res = digitalCircutAction.checkTradeId(newAddObj).responseJSON.data;
