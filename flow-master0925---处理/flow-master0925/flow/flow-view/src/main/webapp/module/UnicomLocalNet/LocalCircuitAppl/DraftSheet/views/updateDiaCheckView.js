define(['module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/action/digitalCircutAction.js',
    'text!module/UnicomLocalNet/LocalCircuitAppl/DraftSheet/templates/updateDiaCheckView.html',
...
], function(digitalCircutAction,updateDiaCheckView,i18n,css) {
    return fish.View.extend({
        template: fish.compile(updateDiaCheckView),
