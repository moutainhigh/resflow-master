define(['text!module/UnicomLocalNet/resmaster/portal/checkFlow/templates/specialtyCheckViewDouble.html',
    ...
    'module/UnicomLocalNet/resmaster/portal/orderWorkDeal/action/orderDetailsAction',
], function(operOrderView, operOrderAction, orderStandbyAction, orderDetailsAction, i18n, css, orderDetailsAction) {
    let srvOrdIds;
    let userInfo;
    let sysResource;
    let meOpera;
    ...
    return fish.View.extend({
        ...
        initBox : function (holder, selectId, data) {
            ...
            } else if (selectId.indexOf("PROPERTY_REDLINE") != -1) {
        ...
        changeRequire2: function (selectId) {
            ...
            console.log("校验规则");
            console.log(rules);
            console.log($("#A_RES_PROVIDE_STAND").combobox("value"));
            console.log($("#Z_RES_PROVIDE_STAND").combobox("value"));
