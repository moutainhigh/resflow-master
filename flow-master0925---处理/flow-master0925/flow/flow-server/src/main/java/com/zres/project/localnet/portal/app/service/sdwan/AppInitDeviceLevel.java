...
import com.zres.project.localnet.portal.app.sdwan.AppQueryCircuitIntf;
 ...
 * @Description TODO 终端信息查询--设备标准初始化
 * @Author wang.g2
 * @Date 2020/6/3 9:36
 */
@RestController
public class AppInitDeviceLevel implements AppInitDeviceLevelIntf {
     ...
     */
    @IgnoreSession
    @RequestMapping(value="/interfaceBDW/initDeviceLevel.spr", produces = "application/json;charset=UTF-8")
    @Override
    public Map<String,Object> initDeviceLevel(@RequestBody String request) {
        Map<String,Object> returnmap = new HashMap();
        Map<String,Object> logInfo = new HashMap<String, Object>();
        logInfo.put("interfname","initDeviceLevel终端信息查询-设备标准初始化");
        logInfo.put("url","/interfaceBDW/initDeviceLevel.spr");
        logInfo.put("request",request);
        logInfo.put("remark","接收app 终端信息查询-设备标准初始化 json报文");
        try {
