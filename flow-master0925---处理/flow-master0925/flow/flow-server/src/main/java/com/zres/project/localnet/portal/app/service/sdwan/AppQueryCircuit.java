 ...
 */
@RestController
public class AppQueryCircuit implements AppQueryCircuitIntf {
     ...
     */
    @IgnoreSession
    @RequestMapping(value="/interfaceBDW/queryCircuit.spr", produces = "application/json;charset=UTF-8")
    @Override
    public Map<String,Object> queryCircuit(@RequestBody String request) {
        Map<String,Object> returnmap = new HashMap();
        Map<String,Object> logInfo = new HashMap<String, Object>();
        logInfo.put("interfname","queryCircuit运维派单提交页面电路信息查询");
        logInfo.put("url","/interfaceBDW/queryCircuit.spr");
        logInfo.put("request",request);
        logInfo.put("remark","接收app sdwan运维派单提交页面电路信息查询 json报文");
        try {
            ...
            returnmap = orderStandbyServiceIntf.qrySrvOrdList(params);
