...
import com.zres.project.localnet.portal.app.sdwan.AppInitDeviceFactoryIntf;
 ...
 * @Description TODO 终端信息查询--设备厂商初始化
 * @Author wang.g2
 * @Date 2020/6/3 9:36
 */
@RestController
public class AppInitDeviceFactory implements AppInitDeviceFactoryIntf {
     ...
     */
    @IgnoreSession
    @RequestMapping(value="/interfaceBDW/initDeviceFactory.spr", produces = "application/json;charset=UTF-8")
    @Override
    public Map<String,Object> initDeviceFactory(@RequestBody String request) {
        Map<String,Object> returnmap = new HashMap();
        Map<String,Object> logInfo = new HashMap<String, Object>();
        logInfo.put("interfname","initDeviceFactory终端信息查询-设备厂商初始化");
        logInfo.put("url","/interfaceBDW/initDeviceFactory.spr");
        logInfo.put("request",request);
        logInfo.put("remark","接收app 终端信息查询-设备厂商初始化 json报文");
        try {
            ...
            List<Map<String, Object>> data = sdwanDealServiceIntf.queryEnum(params);
