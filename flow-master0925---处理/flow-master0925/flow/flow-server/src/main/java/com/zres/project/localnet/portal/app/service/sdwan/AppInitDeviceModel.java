 ...
 * @Description TODO 终端信息查询--设备型号初始化
 * @Author wang.g2
 * @Date 2020/6/3 9:36
 */
@RestController
public class AppInitDeviceModel implements AppInitDeviceModelIntf {
     ...
     */
    @IgnoreSession
    @RequestMapping(value="/interfaceBDW/initDeviceModel.spr", produces = "application/json;charset=UTF-8")
    @Override
    public Map<String,Object> initDeviceModel(@RequestBody String request) {
        Map<String,Object> returnmap = new HashMap();
        Map<String,Object> logInfo = new HashMap<String, Object>();
        logInfo.put("interfname","initDeviceModel终端信息查询-设备型号初始化");
        logInfo.put("url","/interfaceBDW/initDeviceModel.spr");
        logInfo.put("request",request);
        logInfo.put("remark","接收app 终端信息查询-设备型号初始化 json报文");
        try {
