...
import com.zres.project.localnet.portal.app.sdwan.AppTerminalDeliverySubmitIntf;
 ...
 * @Description TODO sdwan终端出库及上门环节提交功能
 * @Author wang.g2
 * @Date 2020/6/3 9:36
 */
@RestController
public class AppTerminalDeliverySubmit implements AppTerminalDeliverySubmitIntf {
     ...
     */
    @IgnoreSession
    @RequestMapping(value="/interfaceBDW/terminalDeliverySubmit.spr", produces = "application/json;charset=UTF-8")
    @Override
    public Map<String,Object> terminalDeliverySubmit(@RequestBody String request) {
        Map<String,Object> returnmap = new HashMap();
        Map<String,Object> logInfo = new HashMap<String, Object>();
        logInfo.put("interfname","terminalDeliverySubmit终端出库及上门环节提交");
        logInfo.put("url","/interfaceBDW/terminalDeliverySubmit.spr");
        logInfo.put("request",request);
        logInfo.put("remark","接收app 终端出库及上门环节提交 json报文");
        try {
