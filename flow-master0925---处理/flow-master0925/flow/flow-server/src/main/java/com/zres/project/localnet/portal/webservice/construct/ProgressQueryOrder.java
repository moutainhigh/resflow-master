...
/**
 * @ClassName ProgressQueryOrder
 * @Description TODO  oss To  工建  进度查询
 * @Author wang.g2
 ...
 */
@Service
public class ProgressQueryOrder implements ProgressQueryOrderIntf{

    private static Logger logger = LoggerFactory.getLogger(ProgressQueryOrder.class);
    ...
    @Override
    public Map<String, Object> progressQueryOrder(@RequestParam Map<String, Object> params) {
    ...
    private void insertInterfaceLog(String tradeId,String request,String respone){
        ...
        interflog.put("INTERFNAME","OSS To 工建系统 进度查询接口");
