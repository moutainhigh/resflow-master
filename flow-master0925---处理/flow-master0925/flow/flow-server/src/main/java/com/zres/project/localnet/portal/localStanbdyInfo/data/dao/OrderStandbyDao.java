...
public interface OrderStandbyDao {
    ...
    /**
     * 查询业务订单--电路信息 主流程时--二干下发本地网
     * @param params
     * @return
     */
    public List<Map<String, Object>> qrySrvOrdListSecond(Map<String, Object> params);
 ...
 /*
     ...
     * @return
     */
    List<Map<String, Object>> qrySrvOrdListCheckNew(Map<String, Object> params);

    //void removeAttach(@Param("array") String[] delFilesList, @Param("woId") String woId);
    void removeAttach(@Param("arrayList") String[] delFilesList);

    List<Map<String,Object>> qrySecondSrvOrdListCheck(Map<String, Object> params);
