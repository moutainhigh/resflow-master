...
public class TacheWoOrderEntry {
    ...
    enum Tache {
        ...
        //定义枚举类
        LOCAL_TEST("LOCAL_TEST") { //本地测试--跨域电路
            @Override
            public String getMethodName(String tacheCode) {
                return "mainDispService";
            }
        },
        WHOLE_COURSE_TEST("WHOLE_COURSE_TEST") { //全程调测--客户电路
            @Override
            public String getMethodName(String tacheCode) {
                return "mainDispService";
            }
        ...
        UNION_DEBUG_TEST("UNION_DEBUG_TEST") { //联调测试
            @Override
            public String getMethodName(String tacheCode) {
        ...
        COMPLETE_CONFIRM("COMPLETE_CONFIRM") { //完工确认
            @Override
            public String getMethodName(String tacheCode) {
                return "completeConfirmDispService";
            }
        };
