...
public class ExcelContext  {
	 ...
	 * @throws Exception
	 */
	public Workbook createExcel(String id, List<?> beans ,String sheetName) throws Exception {
		return createExcel(id, beans, null, null, sheetName);
	}
	 ...
	 * @throws Exception 
	 */
	public Workbook createExcel(String id, List<?> beans,ExcelHeader header,List<String> fields,String sheetName) throws Exception {
		return excelExport.createExcel(id, beans,header,fields,sheetName).build();
	}
	 ...
	 * @throws Exception
	 */
	public ExcelImportResult readExcel(String id,Integer titleIndex, InputStream excelStream,Integer sheetIndex,boolean multivalidate,int dataRowIndex) throws Exception {
		return excelImport.readExcel(id,titleIndex, excelStream,sheetIndex,multivalidate,dataRowIndex);
	}
